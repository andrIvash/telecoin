...
const calculateSignals = async (currency, timeframe, cb) => {
    ...
    try {
        // Fetch historical price data for trend calculation
    ...
    try {
        ...
        const { rawPrices, ticks } = await fetchPriceData({
            client: binance,
            symbol,
            interval
        });
        // Calculate technical indicators
        const indicators = utils.calculateTechIndicatorsData({
            periods,
            rawPrices,
            ticks
        });
